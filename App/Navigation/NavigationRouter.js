      ...
      <Router>
        <Scene key='drawer' component={NavigationDrawer} open={false}>
          <Scene key='drawerChildrenWrapper' navigationBarStyle={Styles.navBar} titleStyle={Styles.title} leftButtonIconStyle={Styles.leftButton} rightButtonTextStyle={Styles.rightButton}>
            <Scene key='todoList' component={TodoList} title='Todo' />
            <Scene initial key='presentationScreen' component={PresentationScreen} title='Todo' renderLeftButton={NavItems.hamburgerButton} />
            ...
            <Scene key='modal' component={ExampleModal} title='Popup' />
